        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {events.map((event) => (
            <motion.div
              ...
              className="relative rounded-3xl overflow-hidden shadow-xl bg-white border border-gray-200 hover:shadow-2xl transition group"
            >
              {/* Image */}
              ...
              <div className="p-6">
                ...
                <div className="mt-6 flex justify-between items-center">
                  ...
                  <button className="px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium shadow hover:shadow-lg hover:opacity-90 transition">
                    View Details
                  </button>
                </div>
              </div>
              ...
              <div className="absolute inset-0 rounded-3xl pointer-events-none opacity-0 group-hover:opacity-100 transition">
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-indigo-300 to-purple-100 opacity-20 blur-lg"></div>
              </div>
            </motion.div>
          ))}
        </div>
